...
#             filtered_stack = np.zeros_like(stack_pad)
#             filtered_stack[0] = stack_pad[0]
#             for i in range(stack_pad.shape[0]):
#                 filtered_frame = ImagingUtils.edge_filtering(
#                     stack_pad[i], 
#                     sigma_edge = 5, 
#                     sf_val = 0.5,
#                 )

#                 filtered_stack[i] = filtered_frame
    
#                 stack_pad = filtered_stack
