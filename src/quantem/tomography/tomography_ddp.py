...
from quantem.tomography.dataset_models import (
    TomographyINRDataset,  # Only INR dataset is supported for DDP
)
...
class TomographyDDP:
    ...
    def setup_dataloader(
        self,
        tomo_dataset: TomographyINRDataset,
        batch_size: int,
        num_workers: int = 0,
        val_fraction: float = 0.0,
        volume_size: int = 500,  # Assuming N^3 volume size
    ):
